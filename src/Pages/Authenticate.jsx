...
const Authenticate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://projet-inf4288.onrender.com/api/authenticate/extract', formData, {
        headers: {
  ...
  const handleCancel = () => {
    ...
    navigate('/authenticate'); // Redirection vers la page de numérisation après annulation
  };
    ...
    <div className="main-container d-flex flex-column justify-content-center align-items-center min-vh-100">
      ...
      {!showForm ? (
        <form onSubmit={handleSubmit} className="w-50">
          <h2 className="text-center mb-4 tyu">Authentication Birth Certificate</h2>
          <div className="mb-3">
        ...
        <div className="d-flex justify-content-center mt-4">
          <button className="btn btn-secondary me-2" style={{ position: 'absolute', top: '1100px', left: '600px' }} onClick={handleCancel} disabled={confirming}>
            Cancel
          </button>
          <button className="btn btn-primary" style={{ position: 'absolute', top: '1100px', left: '90px' }} onClick={handleConfirm} disabled={confirming}>
