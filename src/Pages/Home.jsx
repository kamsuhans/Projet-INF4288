  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row gy-4 align-items-center justify-content-between">
      ...
      <div class="col-lg-6">
        ...
        <h3 class="fw-bold fs-2 mb-3">Our Vision</h3>
        <p>
        Our vision is to create a transparent and trustworthy environment where every birth certificate in Cameroon is digitized and authenticated, paving the way for a fraud-free society.        </p>
